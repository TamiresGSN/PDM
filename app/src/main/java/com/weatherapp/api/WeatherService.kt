...
class WeatherService(private val context: Context) {
    ...
    // Prática 09 - Parte 2 - Passo 1: componente da Coil que carrega imagens da rede
    ...
    // Prática 09 - Parte 2 - Passo 1: carrega uma imagem da rede em um Bitmap
    fun getBitmap(imgUrl: String, onResponse: (Bitmap?) -> Unit) {
        val request = ImageRequest.Builder(context)
            ...
            .target(
                onSuccess = { drawable ->
                    // Uso de safe cast (as?) para evitar ClassCastException caso o formato varie
