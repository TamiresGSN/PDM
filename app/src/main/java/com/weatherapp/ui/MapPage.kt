...
fun MapPage(modifier: Modifier = Modifier, viewModel: MainViewModel) {
    ...
    GoogleMap(
        ...
        onMapClick = { latLng ->
            // 🌐 Prática 07: Chama a API de clima para descobrir o nome real do local clicado antes de salvar
            viewModel.addCity(latLng)
        }
    ) {
        viewModel.cities.forEach { city ->
            if (city.location != null) {
                // Prática 09 - Parte 2 - Passo 4: usa o bitmap do clima como marcador
